...
export default function Principles(){
    return(
        <div className="p-16">
            <p className="text-neutral-600 text-[15px] ">Our Principles</p>
            <div className="mb-12 flex  justify-start">
                <div className=" flex-1 min-w-0">
                <h1 className="text-5xl ">You don't need a glossary to understand your own wealth.</h1>
                </div>
                <div className="flex-1 min-w-0 text-neutral-600">
            ...
            <div className="grid grid-rows-2 grid-flow-col mb-12 mt-12 gap-3 ">
                <div className="row-span-2 border border-neutral-300 p-7 bg-neutral-100">
                    ...
                    <h1 className="mt-5 text-slate-950">No jargon</h1>
                    <p className="max-w-[500px]">You ran a company. You don't need someone explaining what diversification means. We skip that part.</p>
                </div>
                <div className="border border-neutral-300 p-7 bg-neutral-50 flex flex-col gap-24">
                    <h1 className=" text-2xl">Decision, not reports</h1>
                    <p className="text-neutral-700">We don't send you a PDF every quarter. We tell you what to do next and explain the thinking behind it.</p>
                </div>
                <div className="border border-neutral-300 bg-neutral-50 p-7 bg-neutral-50 flex flex-col gap-24">
                    <h1 className=" text-2xl">The full picture</h1>
                    <p className="text-neutral-700">Your wealth isn't in one place, so your view of it shouldn't be either. <br></br>
                    We connect everthing.</p>
                </div>

            </div>
            <div className="h-[1px] w-full bg-neutral-300 mt-24 "></div>
        </div>
